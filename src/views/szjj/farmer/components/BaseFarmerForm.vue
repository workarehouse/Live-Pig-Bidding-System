      ...
      <a-row>
        ...
        <a-col :span="8">
          <a-form-item label="BI猪场" v-bind="validateInfos.mhid">
            <j-dict-select-tag v-model:value="formData.mhid"
              dictCode="bi_farmer WHERE is_daily=1 ORDER BY mh_fram_name,mh_fram_name,mh_fram_id" placeholder="请选择类型"
              :disabled="disabled" :showChooseOption="false" />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="8">
          <a-form-item label="预收款比例" v-bind="validateInfos.clamrate">
            <a-input-number v-model:value="formData.clamrate" placeholder="请输入预收款比例" :disabled="disabled" :min="0"
              :max="10" :step="0.1" style="width: 100%" />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="8">
          <a-form-item label="收款账号" v-bind="validateInfos.lpno">
            <j-dict-select-tag v-model:value="formData.lpno"
              dictCode="xms_bank_info WHERE state='Y' ORDER BY lpno,lpcpy,lpno" placeholder="请选择类型" :disabled="disabled"
        ...
        <a-col :span="8">
          <a-form-item label="磅秤标志" v-bind="validateInfos.scaleflg">
            <j-dict-select-tag placeholder="请选择磅秤标志" v-model:value="formData.scaleflg" dictCode="pig_scaleflg"
              :showChooseOption="false" :allowClear="true" />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="8">
          <a-form-item label="销售业务BIP编码" v-bind="validateInfos.lnkmancod">
            <a-input v-model:value="formData.lnkmancod" placeholder="销售业务BIP编码" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
...
const validatorRules = {
  ...
  auditing: [{ required: true, message: '请选择状态!' }],
}
