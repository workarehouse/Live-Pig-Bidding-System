...
export enum Api {
    queryDepartTreeSync = '/xmsale/xmsSalorg/queryTreeSync',
    save = '/xmsale/xmsSalorg/add',
    edit = '/xmsale/xmsSalorg/edit',
    delete = '/xmsale/xmsSalorg/delete',
    deleteBatch = '/xmsale/xmsSalorg/deleteBatch'
}
...
export const saveOrUpdateDepart = (params, isUpdate) => {
    console.log('saveOrUpdateDepart', params, isUpdate, Api.save)
