...
export enum Api {
    queryDepartTreeSync = '/xmsale/xmsRptorg/queryTreeSync',
    save = '/xmsale/xmsRptorg/add',
    edit = '/xmsale/xmsRptorg/edit',
    delete = '/xmsale/xmsRptorg/delete',
    deleteBatch = '/xmsale/xmsRptorg/deleteBatch'
}
